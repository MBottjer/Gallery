...
$(document).ready(function() {
  ...
  elemm.onclick = function() { 
    ...
    $('.example-orbit').empty();
      getJsonViaAjax("http://www.countryrosefurniture.co.uk/home/index.json&callback=?", 2)
   };

  $("#home").click(function() {
    $('.example-orbit').empty();
      getJsonViaAjax("http://www.countryrosefurniture.co.uk/home/index.json&callback=?", 1)
  });
